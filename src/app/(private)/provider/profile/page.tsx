...
busco deixar tudo impecável."
          ...
          <Card className="p-8 max-sm:p-4 max-sm:w-[90vw] w-[60vw] bg-background border-1 border-accent rounded-2xl shadow-2xl">
            <div className="w-full flex justify-between max-sm:flex-col max-sm: gap-4">
              <div className="flex items-center gap-4">
            ...
            <div className="border-1 p-8 max-sm:p-4 flex flex-col gap-8 rounded-sm">
          ...
          <Card className="p-8 max-sm:w-[90vw] w-[60vw] bg-background border-1 border-accent rounded-2xl shadow-2xl">
            ...
            <div className="flex flex-col gap-2">
              <label
                htmlFor="monday"
                className="flex max-sm:flex-col max-sm:gap-4 justify-between  hover:bg-accent hover:scale-103 transition-all items-center w-full p-4 border rounded-md cursor-pointer"
              >
                <div className="flex items-center gap-4">
                  <Checkbox id="monday" />
                  <span>Domingo</span>
                ...
                <div className="flex gap-4 max-sm:gap-2 relative max-sm:flex-col items-center">
                  <Input
                    type="time"
                    id="time-picker"
                    step="1"
                  ...
                  />
                  <span className="max-sm:absolute max-sm:top-7 max-sm:bg-accent max-sm:border-1 max-sm:px-2 max-sm:rounded-lg">
                    às
                  </span>
                  <Input
                    type="time"
          ...
          <Card className="p-8 max-sm:w-[90vw] w-[60vw] bg-background border-1 border-accent rounded-2xl shadow-2xl">
            ...
            <div className="w-full max-sm:flex-col flex flex-1 flex-row gap-4 justify-between">
              <Card className="shadow-none text-center border-dashed flex-1 flex flex-col gap-1 items-center text-neutral-700">
                <FileText />
                RG ou CNH
                <Button variant={"outline"}>Enviar documento</Button>
              </Card>
              <Card className="shadow-none border-dashed text-center flex-1 flex flex-col gap-1 items-center text-neutral-700">
                <FileText />
          ...
          <Card className="p-8 flex gap-2 max-sm:p-2 max-sm:flex-col flex-row max-sm:w-[90vw] w-[60vw] bg-background border-1 border-accent rounded-2xl shadow-2xl">
